!(function () {
    ...
    function o(e) {
        const t = e.target,
            n = document.getElementById("mobiletoc");
        n &&
            t &&
            !n.contains(t) &&
    ...
    (window.searchControlButton = null),
        e <= 742
            ? ((t = document.getElementsByClassName("darkwidget")[0]),
              (window.searchControlButton =
                  document.getElementsByClassName("searchwidget")[0]))
            : ((t = document.getElementsByClassName("darknavbar")[0]),
              (window.searchControlButton =
                  document.getElementsByClassName("searchnavbar")[0])),
        t.addEventListener("click", () => {
            window.setDarkmode(window.reverseDarkModeSetting());
        });
    const n = () => {
        const e = document.getElementById("mobiletoc");
        if (!e) return;
    ...
    const l = () => {
        ...
        n <= 862 &&
            l &&
            ("1" === t.style.opacity
                ? ((t.style.right = "32px"), (t.style.opacity = "0"))
                : ((t.style.right = "85px"), (t.style.opacity = "1")));
        const s = document.querySelector(".darkwidget"),
            c = document.querySelector(".searchwidget");
        n <= 742 &&
            ("1" === s.style.opacity
                ? ((s.style.bottom = "32px"),
                  (s.style.opacity = "0"),
            ...
            "1" === c.style.opacity
                ...
                : ((c.style.display = "flex"),
                  ...
                  (c.style.bottom = "191px"),
                  (c.style.opacity = "1")));
    };
    setTimeout(() => {
        document.getElementById("popbutton").addEventListener("click", l);
    }, 0);
    const s = () => {
        let e =
            window.pageYOffset ||
        ...
        e > 1
            ? (window.requestAnimationFrame(s),
              scrollTo(0, Math.floor(0.85 * e)))
            : scrollTo(0, 0);
    };
    function c(e) {
        const t = document.querySelector("#local-search");
        ...
        setTimeout(() => {
            window.searchControlButton &&
                window.searchControlButton.addEventListener("click", () => {
                    ...
                    (document.querySelector("#local-search").style.display =
                        "block"),
                        setTimeout(() => {
            ...
            fetch("/search.json")
                ...
                .then((e) => {
                    let t = document.getElementById("search-input"),
                        o = document.getElementById("search-content");
                            ...
                            if (
                                (e.forEach(function (e) {
                                    ...
                                    if (
                                        ...
                                        const o = e.content;
                                        if (c >= 0) {
                                            const e = Math.max(0, c - 12),
                                                l = Math.min(o.length, c + 12);
                                            let s = o.substr(e, l);
                                            (s = s.replace(
                                                new RegExp(n, "gi"),
